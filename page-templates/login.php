<?php
/*s
Template Name:Вхід у особистий кабінет
...
?>
    <div class="login__content">
        <div class="container--small mx-auto">
            <h1 class="text-center"><?php _e( 'Log in personal cabinet', 'krop' ); ?></h1>
            <div class="login__form">
                <form action="<?= get_permalink(); ?>" method="POST" id="profile_form">
                    <div class="login__form__head mx-auto">
                        <a href="<?php echo esc_url(splitter_lang_condition( array('ukr' => home_url( '/login/' ), 'eng' => home_url( '/eng/sign-in/' ) ) )) ?>"
                           class="login__form__head__elem login__form__head__elem--active">
                            <svg class="active-icon d-block" width="20" height="20" viewBox="0 0 20 20" fill="none"
                            ...
                            <svg class="inactive-icon d-none" width="20" height="20" viewBox="0 0 20 20" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                                <path
                                        d="M10 0C4.48609 0 0 4.48609 0 10C0 15.5139 4.48609 20 10 20C15.5139 20 20 15.5139 20 10C20 4.48609 15.5139 0 10 0ZM10 1.25001C14.8248 1.25001 18.75 5.17519 18.75 10C18.75 12.0101 18.0617 13.8583 16.918 15.3373C12.5311 13.2611 7.46884 13.2611 3.082 15.3373C1.93827 13.8583 1.25001 12.0101 1.25001 10C1.25001 5.17519 5.17519 1.25001 10 1.25001ZM3.95881 16.3145C7.81518 14.6064 12.1848 14.6064 16.0412 16.3145C14.469 17.8193 12.343 18.7501 10 18.7501C7.657 18.7501 5.531 17.8192 3.95881 16.3145Z"
                                        fill="#333333"/>
                        ...
                        <a href="<?php echo esc_url(splitter_lang_condition( array('ukr' => home_url( '/registration/' ), 'eng' => home_url( '/eng/register/' ) ) ))?>" class="login__form__head__elem">
                    ...
                    <input type="text" class="login__form__input mobile-placeholder invalid_username" name="log"
                           data-moblile-placeholder-text="<?php _e( 'mail@example.com', 'krop' ); ?>"
                           data-default-placeholder-text="<?php _e( 'For example mail@example.com', 'krop' ); ?>"
                    ...
                    <div class="login__form__input-error invalid_username invalid_email" aria-hidden="true">
						<?php _e( 'Invalid email, please try again', 'krop' ); ?>
                    </div>
                    ...
                    <div class="d-flex flex-wrap flex-dir-column position-relative div-password-field">
                        <input type="password" class="login__form__input mobile-placeholder incorrect_password"
                               name="pwd"
                               data-moblile-placeholder-text="<?php _e( 'Enter password', 'krop' ); ?>"
                               data-default-placeholder-text="<?php _e( 'Enter password', 'krop' ); ?>"
                               placeholder="<?php _e( 'Enter password', 'krop' ); ?>"
                               required>
                        ...
                        <div class="login__form__input-error incorrect_password" aria-hidden="true">
							<?php _e( 'Incorrect password, please try again', 'krop' ); ?>
                        </div>
                    </div>

                    <div class="login__form__checkbox checkbox">
                        <input class="custom-checkbox" type="checkbox" id="checkbox-login" name="rememberme"
                               value="remember_me">
                        <label for="checkbox-login"><?php _e( 'Remember me', 'krop' ); ?></label>
                    </div>
                    <input type="hidden" name="_wpnonce" value="<?php echo $login_nonce; ?>">
                    <input type="hidden" name="action" value="login">
                    <button type="submit"
                            class="btn btn--primary login__form__btn"><?php _e( 'Log in to my personal cabinet', 'krop' ); ?>
                    ...
                    <div class="d-md-flex d-block align-center justify-content-center">
                        <div class="login__form__bottom-text text-center"><?php _e( 'Forgot your password?', 'krop' ); ?></div>
                        <a href="<?php echo wp_lostpassword_url(); ?>"
                           class="login__form__link d-flex text-center justify-content-center"><?php _e( 'Restore password', 'krop' ); ?></a>
                    </div>
                </form>
            </div>
        </div>
