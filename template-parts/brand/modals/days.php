<div class="modal days__modal add-brand__modal" data-modal="modal-category">
    <div class="category__head d-flex justify-content-between w-100">
        <div class="category__title">
	        <?php _e('Select your days of the week:', 'krop'); ?>
        </div>
    ...
    <div class="row category__list">
        <div class="category__item">
            <label class="checkbox"><input type="checkbox" name="monday"><?php _e('Monday', 'krop'); ?></label>
        </div>
        <div class="category__item">
            <label class="checkbox"><input type="checkbox" name="tuesday"><?php _e('Tuesday', 'krop'); ?></label>
        </div>
        <div class="category__item">
            <label class="checkbox"><input type="checkbox" name="wednesday"><?php _e('Wednesday', 'krop'); ?></label>
        </div>
        <div class="category__item">
            <label class="checkbox"><input type="checkbox" name="thursday"><?php _e('Thursday', 'krop'); ?></label>
        </div>
        <div class="category__item">
            <label class="checkbox"><input type="checkbox" name="friday"><?php _e('Friday', 'krop'); ?></label>
        </div>
        <div class="category__item">
            <label class="checkbox"><input type="checkbox" name="saturday"><?php _e('Saturday', 'krop'); ?></label>
        </div>
        <div class="category__item">
            <label class="checkbox"><input type="checkbox" name="sunday"><?php _e('Sunday', 'krop'); ?></label>
        </div>
    </div>
