<div class="calendar-modal timepicker-modal" id="timepicker-modal">
    <div class="calendar-modal__content">
        <h3 class="calendar-modal__title"><?php _e( 'Choose the time you want', 'krop' ); ?></h3>
        <button type="button" class="calendar-modal__close-button" id="timepicker-modal-close-button">
        ...
        <div class="timepicker-modal__wrapper">
            <div class="timepicker-modal__inputs">
                ...
                <input class="timepicker-input timepicker-input-from" id="timepicker-input">
                <p><?php _e( 'To:', 'krop' ); ?></p>
                <input class="timepicker-input timepicker-input-until" id="timepicker-input2">
            </div>
            <button type="button" class="btn btn--primary" id="timepicker-modal-apply-button">
				<?php _e( 'Confirm', 'krop' ); ?>
