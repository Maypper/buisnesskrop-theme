<div class="modal personal__modal personal__modal__padding-small add-brand__modal" data-modal="modal-send-brand">
    ...
    <div class="personal__modal__text personal__modal__text__margin"><?php _e( 'Thank you for your contribution to the portal!', 'krop' ); ?>
        <br>
		<?php _e( 'Your request for brand/business ownership', 'krop' ); ?>
        <span class="personal__modal__text__color font-weight-bold" id="post_title"></span>
		<?php _e( 'will be reviewed by an administrator shortly. You can check the availability of the business/brand in personal account or on the', 'krop' ); ?>
        <a href="<?php echo home_url( splitter_lang_condition( array('ukr' => '/edit-account/', 'eng' => '/eng/personal-account/' ) ) ); ?>"
           class="personal__modal__text__link personal__modal__text__color"><?php _e( 'Personal account', 'krop' ); ?>
        </a>.
    </div>
