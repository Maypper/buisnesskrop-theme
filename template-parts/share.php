<div class="article-content__share-wrapper <?php echo $args['class'] ?? ''; ?>">
    <div class="share">
        <div class="share__social">
            <span><?php _e( 'Share the news', 'krop' ); ?></span>
            <ul class="share__social-list">
                <li class="share__social-item">
                    <a href="<?php echo social_share_link( 'facebook' ); ?>" target="_blank">
                ...
                <!--                </li>-->
                <li class="share__social-item">
                    <a href="<?php echo social_share_link( 'messenger' ); ?>" target="_blank">
                ...
                <li class="share__social-item">
                    <a href="<?php echo social_share_link( 'telegram' ); ?>" target="_blank">
                ...
                <li class="share__social-item">
                    <a href="<?php echo social_share_link( 'twitter' ); ?>" target="_blank">
        ...
        <div class="share__date">
            <svg width="24" height="25" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
                        d="M22 14.531V4.076c0-1.124-.898-2.038-2-2.038h-3V.509A.504.504 0 0 0 16.5 0c-.276 0-.5.228-.5.51v1.528H7V.509A.504.504 0 0 0 6.5 0c-.276 0-.5.228-.5.51v1.528H2c-1.103 0-2 .914-2 2.038v16.303c0 1.124.897 2.038 2 2.038h12.26a5.453 5.453 0 0 0 4.24 2.038c3.032 0 5.5-2.514 5.5-5.604 0-1.737-.78-3.291-2-4.32ZM1 4.076a1.01 1.01 0 0 1 1-1.02h4v1.02c-.552 0-1 .457-1 1.019a1.01 1.01 0 0 0 1 1.019c.552 0 1-.458 1-1.02V3.058h9v1.019c-.552 0-1 .457-1 1.019a1.01 1.01 0 0 0 1 1.019c.552 0 1-.458 1-1.02V3.058h3c.552 0 1 .457 1 1.019v3.057H1V4.076Zm1 17.322c-.552 0-1-.457-1-1.019V8.152h20v5.713a5.376 5.376 0 0 0-2.5-.619c-3.032 0-5.5 2.514-5.5 5.605 0 .917.222 1.782.607 2.547H2Zm16.5 2.038c-2.482 0-4.5-2.057-4.5-4.585 0-2.529 2.019-4.586 4.5-4.586s4.5 2.057 4.5 4.586c0 2.528-2.019 4.585-4.5 4.585Z"
                        fill="#6B2A14"/>
                <path
                        d="M19 18.64v-2.846a.505.505 0 0 0-.5-.51c-.276 0-.5.228-.5.51v3.057c0 .135.053.265.146.36l1.5 1.529a.494.494 0 0 0 .708 0 .516.516 0 0 0 0-.721L19 18.639Z"
                        fill="#6B2A14"/>
            </svg>
